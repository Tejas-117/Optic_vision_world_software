...
{/* 
      ...
      padding="30px">
        ...
        <Box>
          <Typography variant="h5" color={colors.greenAccent[400]} fontWeight="bolder">Total amount</Typography>
          <Typography fontWeight="bolder" variant="h1" mt = "0px "> Rs. {total.toLocaleString()} /-</Typography>
        </Box>
